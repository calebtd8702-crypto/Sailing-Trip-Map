...
Single-page web app. No build, no install, no API keys. New here? The app runs a guided tour on first visit (replay with the **?** button), or read the [full tutorial](docs/tutorial.md).
